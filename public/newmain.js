...
var settext = function(n, a){
  console.log('settext');
  document.getElementById("varline1").innerHTML = a;
  document.getElementById("varline2").innerHTML = n;
  console.log("textset");
  }
var init = function(){
...
//  console.log(
  if(words['noun'] && words['adjective']){
    document.getElementById("varline1").innerHTML = words['adjective'];
    document.getElementById("varline2").innerHTML = words['noun'];
  } else {
...
var read = function(){
  var adjective = document.getElementById("varline1").innerHTML;
  var noun = document.getElementById("varline2").innerHTML;
  var words = QueryString;
  var querystart = document.URL.indexOf("?");
  var rooturl = document.URL.substring(0, querystart);
  document.getElementById("isay").play();
  var fullnewurl = rooturl + "?adjective=" + document.getElementById("varline1").innerHTML + "&noun=" + document.getElementById("varline2").innerHTML;
  console.log(fullnewurl);
  location.assign(fullnewurl);
  var startofadjective = fullnewurl.indexOf("=") + 1;
  var endofadjective = fullnewurl.indexOf("&") - 1;
  var startofnoun = fullnewurl.lastIndexOf("=") + 1;
  var adjective = fullnewurl.substring(startofadjective, endofadjective);
  var noun = fullnewurl.substring(startofnoun);
  console.log(fullnewurl);
  document.getElementById("varline1").innerHTML = adjective;
  document.getElementById("varline2").innerHTML = noun;
  }
...
var setquery = function(){
  ...
  var querystart = document.URL.indexOf("?");
  var rooturl = document.URL.substring(0, querystart);
  var fullnewurl = rooturl + "?adjective=" + adjective + "&noun=" + noun;
  console.log(fullnewurl);
  location.assign(fullnewurl);
  }
...
var playmusic = function(){
      ...
      var copyurl = function() {
        var querystart = document.URL.indexOf("?");
        var rooturl = document.URL.substring(0, querystart);
        var fullurl = rooturl + "?adjective=" + document.getElementById("varline1").innerHTML + "&noun=" + document.getElementById("varline2").innerHTML;
        ...
        prompt("Here is the link to your USaidIt", fullurl);
        }